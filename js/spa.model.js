...
spa.model = (function () {
  ...
  completeLogin = function ( user_list ) {
    ...
    stateMap.user.permissions = user_map.permissions;
  ...
  makePerson = function ( person_map ) {
    var person,
      ...
      permissions = person_map.permissions;
  ...
  people = (function () {
    ...
    login = function ( name ) {
      ...
      stateMap.user = makePerson({
        ...
        name        : name,
        permissions : [
          {id : 1, url : 'acceuil',        icon : 'ion-home', is_default : true,  name : 'Accueil'   },
          {id : 2, url : 'reception',      icon : 'ion-code', is_default : false, name : 'Reception' },
          {id : 3, url : 'processus',      icon : 'ion-code', is_default : false, name : 'Processus' },
          {id : 4, url : 'rapport',        icon : 'ion-code', is_default : false, name : 'Rapport' },
          {id : 5, url : 'administration', icon : 'ion-code', is_default : false, name : 'Administration' }
        ]
      });
      ...
      sio.emit( 'adduser', {
        ...
        permissions : stateMap.user.permissions
      });
    };
